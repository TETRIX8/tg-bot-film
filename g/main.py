...
async def send(call: types.CallbackQuery):
    ...
    async def handle_text(message: types.Message, state: FSMContext):
     ...
     play.add(types.InlineKeyboardButton(text="😍 Смотреть онлайн", url=f'https://api.strvid.ws/embed/movie/{film_id}'),
     InlineKeyboardButton(text="🤖Смотреть в боте", url=f'https://t.me/OnWavee_bot?start=1404494933'))
