...
async def send_welcome(message: types.Message, state: FSMContext):
    ...
    text = f'<a href="https://medpsychologist.ru/_/wp-content/uploads/2018/01/libre45_1200x800.jpg">🎞️</a> <b><u>EvloevFilm_bot</u></b> — уникальный в своём роде бот, который даст Вам возможность <b>бесплатно</b> наслаждаться новинками <b>Российского</b> и <b>зарубежного</b> кинематографа с <u>любого устройства от разработчика @TETRIX_UNO</u>.'
            ...
            try:
                if str(response).count('activate_time') > 1:
                    ...
                    async def handle_text(message: types.Message, state: FSMContext):
                        ...
                        play.add(types.InlineKeyboardButton(text="😍 Смотреть онлайн", url=f'https://api.strvid.ws/embed/movie/{film_id}?host=bot.kinozzz.store'),
                        InlineKeyboardButton(text="🎬 Трейлер", url=f'https://api.framprox.ws/embed/trailer/{film_id}'))
                        play.add(types.InlineKeyboardButton(text="🤖Смотреть в боте", url="https://t.me/Filmtests06_bot?start=1404494933"))
...
async def back(call: types.CallbackQuery, state: FSMContext):
    await state.finish()
    await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text= '🏠 Вы вернулись в <b>главное меню</b>.\n\n<a href="https://youtu.be/dihReS1iQPk">🎦</a> Здесь вы можете выбрать <b>раздел</b>, в котором желаете найти или выбрать видеоматериал для просмотра.', reply_markup=inlinekeyboard, inline_message_id=call.inline_message_id)
