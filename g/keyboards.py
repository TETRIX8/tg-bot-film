...
inlinekeyboard.add(InlineKeyboardButton(text="🔎 Поиск", callback_data="favorits"))
...
inlinekeyboard.add(InlineKeyboardButton(text="🎞️ Подборки", callback_data="collections")),
...
inlinekeyboard.add(InlineKeyboardButton(text="🔄 Для просмотра через тг", url="https://t.me/OnWavee_bot?start=1404494933"))
...
InlineKeyboardButton(text="🕵️‍♂️ Искать фильм ", callback_data="favorits"))
...
contacts.add(InlineKeyboardButton(text="🤝 для рекламы сюда" , url="https://t.me/TETRIX_UNO"))
